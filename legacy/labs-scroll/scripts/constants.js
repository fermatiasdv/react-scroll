...
/** Carpeta de las imágenes recortadas de productos. */
const PRODUCTS_PATH = './assets/products/recortadas/';

/** Carpeta de las imágenes recortadas de ingredientes. */
const INGREDIENTS_PATH = './assets/ingredients/recortadas/';
